...
app = Flask(__name__)
# CORS(app)
@app.route('/telegram_channels')
def home():
    return render_template('index.html')  # Make sure to replace 'your_html_file.html' with the actual file name
...
async def search():
    ...
    print(f"Received query: {query}")  # Log to console
    if query:
