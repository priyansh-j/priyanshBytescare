...
//     // Append results to the JSON file after each extraction
//     appendResultsToFile(results);
//     return results;
// }
...
// function appendResultsToFile(results) {
//     let existingData = [];
//     if (fs.existsSync('seller_results1.json')) {
//         existingData = JSON.parse(fs.readFileSync('seller_results1.json'));
//     }
//     existingData.push(...results);
//     fs.writeFileSync('seller_results1.json', JSON.stringify(existingData, null, 2));
//     console.log(`Results for ${results.length ? results[0].isbn : 'No ISBN'} saved to file.`);
// }
...
//     const body = await page.content();
//     const results = extractData(body, key);
//     await page.close();  // Ensure the page is closed after extraction
//     return results;  // Return results for a single key
// }
...
// async function scrapeProductIDs(productIDs) {
//     const browser = await puppeteer.launch();
//     const promises = productIDs.map(key => fetchAndExtract(browser, key));
//     const allResults = await Promise.all(promises);
//     let combinedResults = [].concat(...allResults);

//     // Save combined results to JSON file
//     fs.writeFileSync('seller_results1.json', JSON.stringify(combinedResults, null, 2));
//     await browser.close();  // Close browser after all operations
